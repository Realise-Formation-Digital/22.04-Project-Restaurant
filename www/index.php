...
<body id="body" class="page-header">
        ...
        <section class="container sec2">
            ...
            <div class="card bg-transparent">
                ...
                <div class="card-body row d-flex justify-content-center">
                    ...
                    <h1 id="h1" class="text-white text-center card-title mb-3 col-12 col-md-9 col-lg-7">the right
                        ingredients for the right food</h1>
                    ...
                    <div class="row d-flex justify-content-center">
                        ...
                        <button id="button1" class=" btn btn-dark card-link me-4 col-4 col-md-2 rounded-0">BOOK A
                            TABLE</button>




                        <button type="button" class="btn btn-dark card-link col-4 col-md-2 rounded-0 text-white "
                            data-toggle="modal" data-target="#exampleModalLong">SEE THE MENU</button>
    ...
    <div id="about" id="poid-de-principal" class="row justify-content-center">
        ...
        <div id="nourriture-diago" class="col-4">
            ...
            <p class="text-center" id="Text-de-base">
                ...
                coffees make us hard to resist! <br> Stop in today and check us out!
    ...
    <section id="image_background" class=" container-fluid bg-image img-fluid  d-flex align-items-center">
        ...
        <!--niveau N1 cardcont qui fait reference à un contener transparent-->
        <div class="card container bg-transparent border-0">
            <!--cela equivaut à 3 formes trangulaires -->
            <!--1er rectangle vide -->
            <!--2eme rectangle contenant 3 elements -->
            <!--niveau N2 img-card qui fait reference à du text blanc et centré-->
            <div id="ingredients" id="img-card"
                class="card-body text-white row offset-6 col-6 text-center d-flex justify-content-center">
                ...
                <p class="card-text fs-4 mb-5">
                    If you've been to one of our restaurants, you've seen -and tasted- what keeps our customers coming
                    back for
                    more. Perfect materials and freshly baked food, delicious Lambda cakes,muffins,and gourmet coffees
                    make us
        ...
        <div class="menu1 row justify-content-center ">
            ...
            <div id="appetisers-salad" class="col-lg-3 col-10">
                ...
                <div id="appetisers" class="appetisers ">
                    ...
                    <div class="item-al-description font-normal">Refreshing traditional cucumber and garlic yoghurt dip
                    </div>
                    <div class="item-al d-flex justify-content-between gold-color">
                    ...
                    <div class="item-al-description font-normal">Pureed eggplant,garlic,green pepper and tomato dip
                    </div>
                    <div class="item-al d-flex justify-content-between gold-color">
                        <span class="item-al-title">Aubergine Salad</span>
            ...
            <!-- le div suivant représente la deuxieme colonne --------------------------------------------------------->
            <div id="starters-menu" class="col-lg-3 col-10">
                ...
                <div id="main-dishes">
                    ...
                    <div class="row align-items-center" id="resultat"
                        style="border-style:ridge; border-color:rgb(200, 159, 45);"></div>
                </div>
                <div class="buttonDiv">
                    <input type="button" class="button" value="Calculate Total" id="calcButton"
                        onclick="afficherPrix()">
                </div>
                <button type="button" class="btn btn-lg btn-danger" data-toggle="popover" title="ticket"
                    data-bs-content="Voici le ticket de votre selection">Afficher le ticket</button>
    ...
    <section id="reviews" class="img-fluid plat">
        ...
        <div class="card-body bg-image d-flex justify-content-center">
            ...
            <div class="row d-flex justify-content-center">
                ...
                <div id="img-card"
                    class="card col-10 col-lg-6 bg-transparent text-center text-white d-flex justify-content-center">
                    ...
                    <div class="card-img mt-5">
                        <img src="images/Divider Fusionnés.png" alt="ornement de séparation">
                    </div>
                    ...
                    <div class="row d-flex justify-content-center">
                        ...
                        <p class="card-text fs-3 fw-bold col-11 py-5 px-5 lh-lg">
                            ...
                            If you've been to one of our restaurants, you've seen &#150; and tasted &#150; what keeps
                            our customers coming back for more. Perfect materials and freshly backed food, delicious
                            Lambda cakes, muffins and gourmet coffees make us hard to resist! Stop in today and check us
                            out!
                ...
                <div id="reservations" class="reservations" class="col-12 col-xl-5">
                    ...
                    <div class="card bg-transparent">
                        ...
                        <div id="card" class="card-body text-center pt-0">
                            ...
                            <p class="card-text">
                                If you've been to one of our restaurant, you've seen - and tasted - what keeps our
                                customers coming back for more. Perfect materials and freshly baked food.
                            </p>

                            <p class="card-text">
                                Delicious Lambda cakes, muffins, and gourmets coffees make us hard to resist! Stop in
                                today and check us out! Perfect materials and freshly baked food.
                            </p>
                    ...
                    <!--Formulaire-->
                    <form method="post" action="index.php" class="row d-flex justify-content-center gx-0 ">
                        ...
                        <input type="text" class="form-control" placeholder="your adresse *" name="adresse">
                        ...
                        <input type="text" class="form-control" placeholder="your ville *" name="ville">
                        ...
                        <div class="row gx-0 d-flex justify-content-center">
                            ...
                            <div id="date1" class="reserv col-12 col-md-5 me-4 pb-3 form-group">
                            ...
                            <div class="col-12 col-md-5 form-group">
                                ...
                                <label class="form-label pb-0" for="number1">Party number</label>

                                <select class="form-select" placeholder="party number" id="number1">
                                    <option selected>party number</option>
                                    <option value="1">Un</option>
                                    <option value="2">Deux</option>
                                    <option value="3">Trois</option>
                                    <option value="2">Quatre</option>
                                    <option value="3">Cinq</option>
                        ...
                        <div class="reserv col-12 col-md-5 me-4 pb-3 form-group">
                            ...
                            <input type="text" class="form-control" placeholder="your login *" name="Email">

                        </div>

                        <div class="col-12 col-md-5 pb-3 form-group" class="password-icon">
                    ...
                    <h1>Bienvenue,  <?php echo $_POST['nom'] ?></h1>
                    ...
                    <div class="row d-flex justify-content-center pt-5">
                        ...
                        <button id="btn-reservation" class="btn btn-transparent col-6 fs-5 mb-5 text-white">Book
                            now!</button>
                ...
                <div class="row justify-content-evenly">
                    ...
                    <div class="col-10 col-md-3 ">
                        ...
                        <p class="p-footer" id="p-special-footer">
                            Lambda's new and expanded Chelsea location represents a truly authentic <strong>Greek
                            </strong>
                            patisserie, featuring breakfast of fresh croissants and steaming bowls of café.
